...
echo ""
echo "Calibration:"
echo "  Run: bash ~/.claude/scripts/calibrate.sh"
echo "  This generates ~/.claude/timing/calibration.json from measured data."
echo "  The estimate skill auto-reads calibration.json for measured-based predictions."
echo ""
